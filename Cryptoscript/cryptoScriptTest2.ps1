...
$shizzlebag = [ordered] @{
    ...
    XFT   = @{cell = 'I3'; cur = 'eth'; id = 'offshift' }
    PAR   = @{cell = 'I4'; cur = 'eth'; id = 'parachute' }
    PLU   = @{cell = 'I5'; cur = 'eth'; id = 'pluton' }
    TEND  = @{cell = 'I6'; cur = 'eth'; id = 'tendies' }
    UNI   = @{cell = 'I8'; cur = 'eth'; id = 'uniswap' }
    SWAP  = @{cell = 'I9'; cur = 'eth'; id = 'trustswap' }
    AKRO  = @{cell = 'I10';cur = 'eth'; id = 'akropolis' }
    ADEL  = @{cell = 'I11';cur = 'eth'; id = 'akropolis-delphi' }
...
$file = '/Users/schyvensjim/Documents/Atom/CryptoScript/CoinBag.xlsx'
...
foreach($key in $shizzlebag.Keys) {
    ...
    if($key -in $shizzlebagUNI.Keys) {
      ...
      $sheet = if($coin.cur -eq 'eth'){
                  $sheet = $xlsx.Workbook.Worksheets["Total ETH"]
               } else {
                  $sheet = $xlsx.Workbook.Worksheets["Total USD"]
                 }
