...
$shizzlebagUNI = [ordered] @{
    ...
    CHADS = @{ contract='0x69692d3345010a207b759a7d1af6fc7f38b35c5e'; pool='0x960d228bb345fe116ba4cba4761aab24a5fa7213' }
...
$file = '/Users/schyvensjim/Documents/CoinBag.xlsx'
