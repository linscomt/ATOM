...
function Get-Request {
    process {
        Invoke-WebRequest -Uri $PSItem -ContentType 'application/json' | select -ExpandProperty Content | ConvertFrom-Json
    }
}
...
$shizzlebagUNI = [ordered] @{
    ...
    CHADS = @{ contract='0x69692d3345010a207b759a7d1af6fc7f38b35c5e'; pool='0xec81c9eb83e464499b09b38510f967d97363745b' }
    SUSHI = @{ contract='0x6b3595068778dd592e39a122f4f5a5cf09c90fe2'; pool='0xce84867c3c02b05dc570d0135103d3fb9cc19433' }

}

$shizzlebag = [ordered] @{

    BTC   = @{cell = 'GH31';cur = 'eur'; id = 'bitcoin' }
    ETH   = @{cell = 'H30'; cur = 'eur'; id = 'ethereum' }
    CHADS = @{cell = 'M7'; cur = 'eth'; id = 'chads' }
    XFT   = @{cell = 'M7'; cur = 'eth'; id = 'offshift' }
    PAR   = @{cell = 'M7'; cur = 'eth'; id = 'parachute' }
    PLU   = @{cell = 'M7'; cur = 'eth'; id = 'pluton' }
    TEND  = @{cell = 'M6'; cur = 'eth'; id = 'tendies' }
    SUSHI = @{cell = 'M6'; cur = 'eth'; id = 'sushi' }
    UNI   = @{cell = 'M7'; cur = 'eth'; id = 'uniswap' }
    SWAP  = @{cell = 'M7'; cur = 'eth'; id = 'trustswap' }
    AKRO  = @{cell = 'O2'; cur = 'eth'; id = 'akropolis' }
    ADEL  = @{cell = 'O2'; cur = 'eth'; id = 'akropolis-delphi' }
    DOT   = @{cell = 'H3'; cur = 'usd'; id = 'polkadot' }
    GARD  = @{cell = 'H4'; cur = 'usd'; id = 'hashgard' }
    OM    = @{cell = 'H5'; cur = 'usd'; id = 'mantra-dao' }
    ANKR  = @{cell = 'H6'; cur = 'usd'; id = 'ankr' }
    CTSI  = @{cell = 'H7'; cur = 'usd'; id = 'cartesi' }
    XRP   = @{cell = 'H8'; cur = 'usd'; id = 'ripple' }
}
